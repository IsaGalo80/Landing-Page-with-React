    ...
    <div className="container ">
      <div className="row">
        <div className="col-auto ">  
          <div className="card border border-dark "  style={{ width: "16rem" }}>
            <img src={queen} class="card-img-top" alt="..."/>
        ...
        <div className="col-md-3">
          <div className="card border border-warning" style={{ width: "16rem" }}>
            <img src={metalica} class="card-img-top" alt="..." />
            <div className="card-group">
        ...
        <div className="col-md-3">
          <div className="card border border-success" style={{ width: "16rem"}} >
            <img src={acdc} class="card-img-top" alt="..." />
            <div className="card-group">
        ...
        <div className="col-md-3">
          <div className="card border border-primary" style={{ width: "16rem" }}>
            <img src={guns} class="card-img-top" alt="..." />
            <div className="card-group">
